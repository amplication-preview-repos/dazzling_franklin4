...
@InputType()
class MenuItemCreateNestedManyWithoutCategoriesInput {
...
export { MenuItemCreateNestedManyWithoutCategoriesInput as MenuItemCreateNestedManyWithoutCategoriesInput };
